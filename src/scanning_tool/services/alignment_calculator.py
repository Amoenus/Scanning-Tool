...
class AlignmentCalculator:
    ...
    def calculate_aligned_position(
        ...
        base_left = detection.match_left + (detection.template_width / 2.0) - (capture_region.width / 2.0)
        base_top = detection.match_top + (detection.template_height / 2.0) - (capture_region.height / 2.0)

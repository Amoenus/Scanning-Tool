...
- Review repository architecture and coding standards documents (`architecture/README.md`, `architecture/coding-standards.md`, `architecture/decision-log.md`, `prds/00-overview.md`, `prds/01-technical-architecture.md`) whenever starting a new context or task.
...
- Also review repository architecture and coding standards documents before each new task: `architecture/README.md`, `architecture/coding-standards.md`, `architecture/decision-log.md`, `prds/00-overview.md`, `prds/01-technical-architecture.md`.

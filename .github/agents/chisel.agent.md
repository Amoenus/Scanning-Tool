...
- Also review repository architecture and coding standards documents before each new task: `architecture/README.md`, `architecture/coding-standards.md`, `architecture/decision-log/index.md`, `prds/00-overview.md`, `prds/01-technical-architecture.md`.

...
## Purpose
The architecture documentation captures the structural design, package boundaries, and refactor rationale for the repository. It is intended to support future planning and keep the codebase aligned with a clear architecture.
